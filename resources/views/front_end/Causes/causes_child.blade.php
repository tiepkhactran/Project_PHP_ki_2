        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    <h2>Support Children</h2>
                    <p>Welfare activities help children in difficult circumstances</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card_inner_body">
                                <h4 class="card-title">Help children go to school</h4>
                                <p class="card-text">

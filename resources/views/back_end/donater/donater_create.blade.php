                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{url("back/donater/create")}}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
                                @csrf
                                <span class="section">Donater Detail</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="cause_id" class="form-control">
                                            ...
                                            @foreach($causes as $cause)
                                                <option value="{{$cause->cause_id}}">{{$cause->cause_name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" value="{{old("donater_money")}}" name="donater_money" required="required" class="form-control col-md-7 col-xs-12">

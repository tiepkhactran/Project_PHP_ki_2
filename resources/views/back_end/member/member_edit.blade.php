                            ...
                            <form action="{{url("back/member/edit")}}" method="post" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data" >
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="name" value="{{$member->member_name}}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="member_name" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
